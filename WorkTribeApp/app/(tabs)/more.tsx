...
import { Settings, CircleHelp as HelpCircle, FileText, Phone, Star, Share2, LogOut, Globe, Moon, Bell, Shield, ChevronRight } from 'lucide-react-native';
...
export default function MoreScreen() {
  ...
  const MoreOption = ({ 
    ...
    <TouchableOpacity 
      style={[styles.optionItem, SHADOWS.sm]} 
      onPress={onPress}
    >
      <View style={styles.optionLeft}>
        <View style={[
          styles.optionIcon, 
          { backgroundColor: danger ? '#FEE2E2' : colors.surface }
        ]}>
          {icon}
        </View>
